...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Removed legacy n8n webhook test - now using API-only GHL integration

  // Removed legacy GHL webhook test - now using API-only integration

  // Removed legacy webhook test endpoints - now using API-only GHL integration
  ...
  // Removed growth purchase webhook - now handled via Stripe webhook + API-only GHL integration

  // Removed capital purchase and GHL incoming webhooks - now using API-only integration
